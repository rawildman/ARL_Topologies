...
public:
	...
	explicit LinearElasticProblem(const Topologies::TOMesh& inMesh, const Topologies::GenericMaterial& baseMat);
	...
	*/
	...
	const Eigen::VectorXd& getDisplacement() const override {return *pVVec;}
